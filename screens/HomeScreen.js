    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Image source={require("../assets/Notification.png")} style={styles.notifyIcon} />
        </View>

        {/* Search bar */}
        <View style={styles.searchBar}>
          <Image source={require("../assets/Search.png")} style={styles.iconSmall} />
          <TextInput placeholder="Looking for something special?" style={{ flex: 1 }} />
        ...
        >
          ...
          <View style={styles.productInfoWrapper}>
            ...
            <View style={styles.productInfo}>
              ...
              <View style={styles.metaRow}>
                <Image source={require("../assets/home/ShopName.png")} style={styles.metaIcon} />
                <Text style={styles.meta}>Seller / Shop Name</Text>
              </View>

              <View style={styles.metaRow}>
                <Image source={require("../assets/home/Location.png")} style={styles.metaIcon} />
          ...
          <View style={styles.actionRow}>
            <TouchableOpacity>
              <Image source={require("../assets/home/Refresh.png")} style={styles.actionIcon} />
            </TouchableOpacity>
            <TouchableOpacity>
              <Image source={require("../assets/home/X.png")} style={styles.actionIcon} />
            </TouchableOpacity>
            <TouchableOpacity>
              <Image source={require("../assets/home/Like.png")} style={styles.actionIcon} />
            </TouchableOpacity>
            <TouchableOpacity>
              <Image source={require("../assets/home/Cart.png")} style={styles.actionIcon} />
            </TouchableOpacity>
          </View>
        </ImageBackground>
      </View>
